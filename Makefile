...
test: tests/test.o util.o
	$(CXX) $(CXXFLAGS) ${DEFS} -o tests/test tests/test.o util.o

tests/test.o: tests/test.cpp util.h
	$(CXX) $(CXXFLAGS) -o tests/test.o -c tests/test.cpp
